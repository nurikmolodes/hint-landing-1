  ...
  return (
    <div className={"payment"}>
      ...
      <h1 className={"payment__sub-title"}>
        Money shouldn’t stand in the way of finding astrology guidance that finally works. So,
        choose an amount that you think is reasonable to try us out.
      </h1>
        ...
        {prices.map((item, index) => {
          return (
            <div
              ...
              className={`payment__price-item ${
                item === choosesPrice ? "payment__price-item_active" : null
              }`}>
              ${item}
      ...
      <h1 className={`payment__title payment__title_blue ${choosesPrice === "13.00" && "blued"}`}>
