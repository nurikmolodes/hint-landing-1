...
const PaywallPage = () => {
  ...
  useEffect(() => {
    ...
    const counter = setTimeout(() => setSeconds((s) => s - 1), 1000);
    if (seconds <= 0) {
      setMinutes((m) => m - 1);
      setSeconds(59);
    }
  ...
  return (
    <div className={"paywall"}>
      <div className={"paywall__header"}>
        <h1 className={"paywall__header-email"}>{email}</h1>
      </div>
      <div className={"paywall__present-trial"}>
        <h1 className={"paywall__present-trial-title"}>Start Your 7-Day FREE Trial</h1>
      </div>
      <div
        className="rich-text"
        style={{
      ...
      <div className={"paywall__presentation-container"}>
        <div className={"paywall__presentation"}>
          <h5 className={"paywall__presentation-title"}>PERSONALIZED OFFER RESERVED</h5>
          <h5 className={"paywall__presentation-desc"}>
            Your personalized offer has been saved for the next 15 minutes!
          </h5>
          <h5 className={"paywall__presentation-desc"}>Time remaining:</h5>
      ...
      <div className={"paywall__description"}>
        ...
        <div className={"paywall__description-list"}>
          <div className={"paywall__description-item"}>
            <Emotions />
            <span className={"paywall__description-item-title"}>Emotions</span>
          </div>
          <div className={"paywall__description-item"}>
            <Love />
            <span className={"paywall__description-item-title"}>Love</span>
          </div>
          <div className={"paywall__description-item"}>
            <Interest />
            <span className={"paywall__description-item-title"}>Interest</span>
          </div>
          <div className={"paywall__description-item"}>
            <Communication />
            <span className={"paywall__description-item-title"}>Communication</span>
          </div>
          <div className={"paywall__description-item"}>
            <Sex />
            <span className={"paywall__description-item-title"}>Sex</span>
          </div>
          <div className={"paywall__description-item"}>
            <Intellect />
            <span className={"paywall__description-item-title"}>Intellect</span>
          </div>
        </div>
        <div className={"paywall__line"} />
        <div className={"paywall__featured"}>
          <h1 className={"paywall__featured-title"}>HINT HAS BEEN FEATURED IN</h1>
        ...
        <div style={{ display: "flex", justifyContent: "center", padding: "10px", color: "red" }}>
          <span>{data?.response?.data?.message}</span>
        </div>
        <div className={"paywall__line"} />
      </div>
    </div>
