  ...
  return (
    <div className={"enter-page"}>
      <div className={"enter-page__container"}>
        ...
        <h2 className={"enter-page__title"}>Test your compatibility in love</h2>
        <div className={"enter-page__rich-text"}>
          <p className={"enter-page__text"}>
            We've got all the intel on your relationships with romantic partners and crushes.
            Discover what you really need and learn how to strengthen your bond.
          </p>
          <p className={"enter-page__text"}>
