  ...
  return (
    <div className={"hint-intro"}>
      ...
      <h4 className={"hint-intro__desc"}>
        Why? Well, to start with, Synastry is the process of comparing your birth charts. We check
        the positions of the planets using NASA data, analyze what this means, and explain how
        you'll connect.
      </h4>
