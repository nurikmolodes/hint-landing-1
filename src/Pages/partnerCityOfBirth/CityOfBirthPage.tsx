...
import { localStorageItems, Scanner } from "../../utils/constants";
...
const CityOfBirthPage = () => {
  ...
  const click = () => {
    pushToLocalStorage({ value: city, itemName: localStorageItems.PARTNER_CITY_OF_BIRTH });
  ...
  return (
    <div className={"city-of-birth"}>
      <GoBack />
      <h1 className={"city-of-birth__title"}>Where were they born?</h1>
      <h4 className={"city-of-birth__desc"}>
        This determines the time zone at your place of birth to improve the accuracy of your
        compatibility.
      </h4>
